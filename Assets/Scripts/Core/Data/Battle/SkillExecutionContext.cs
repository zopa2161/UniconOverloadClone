...
namespace Core.Data.Battle
{
    public class SkillExecutionContext
    {
        ...
        public SkillExecutionContext(Skill skill,SkillAction skillAction, CharacterInstance caster, List<CharacterInstance> targets ,SkillExecutionContext parentContext = null)
        {
